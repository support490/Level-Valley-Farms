...
const menuStructure = [
  { id: 'home', label: 'Home' },
  {
    id: 'vendors', label: 'Vendors', children: [
      ...
      { id: 'item-receipts', label: 'Item Receipts' },
  ...
  },
  {
    id: 'customers', label: 'Customers', children: [
      ...
      { id: 'refund-receipts', label: 'Refund Receipts' },
      { id: 'customer-deposits', label: 'Customer Deposits' },
  ...
  },
  {
    id: 'banking', label: 'Banking', children: [
      ...
      { id: 'cc-charges', label: 'Credit Card Charges' },
      { id: 'cc-credits', label: 'Credit Card Credits' },
      'separator',
  ...
  {
    id: 'flock', label: 'Flock', children: [
      { id: 'flock-cost-dashboard', label: 'Flock Cost Dashboard' },
      { id: 'flock-pnl', label: 'Flock P&L' },
      { id: 'flock-budget', label: 'Flock Budget' },
      'separator',
      { id: 'flock-closeout', label: 'Flock Closeout' },
      { id: 'grower-settlement', label: 'Grower Settlement' },
      { id: 'grower-payment-formula', label: 'Grower Payment Formula' },
      { id: 'allocate-expense', label: 'Allocate Shared Expense' },
    ],
  },
  {
    id: 'reports', label: 'Reports', children: [
      ...
      { id: 'ap-aging-detail', label: 'AP Aging Detail' },
      { id: 'aging-ar', label: 'AR Aging' },
      { id: 'ar-aging-detail', label: 'AR Aging Detail' },
      'separator',
      { id: 'vendor-balances', label: 'Vendor Balances' },
      { id: 'customer-balances', label: 'Customer Balances' },
  ...
  },
  {
    id: 'tools', label: 'Tools', children: [
      { id: 'batch-invoicing', label: 'Batch Invoicing' },
      { id: 'batch-void', label: 'Batch Void' },
      'separator',
      { id: 'memorized-transactions', label: 'Memorized Transactions' },
    ],
  },
  {
